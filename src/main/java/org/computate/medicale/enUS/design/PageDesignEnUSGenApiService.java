...
/**
 * Translate: false
 * CanonicalName.frFR: org.computate.medicale.frFR.design.DesignPageFrFRGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface PageDesignEnUSGenApiService {
	static void registerService(SiteContextEnUS siteContext, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate-medicale-enUS-PageDesign").register(PageDesignEnUSGenApiService.class, new PageDesignEnUSApiServiceImpl(siteContext));
	}
