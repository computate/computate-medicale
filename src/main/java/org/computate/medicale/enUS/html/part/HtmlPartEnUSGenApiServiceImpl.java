...
import org.computate.medicale.enUS.design.PageDesignEnUSGenApiServiceImpl;
...
/**
 * Translate: false
 * CanonicalName.frFR: org.computate.medicale.frFR.html.part.PartHtmlFrFRGenApiServiceImpl
 **/
					...
					case "setPageDesignKeys":
						...
						if(o.getPageDesignKeys() != null) {
							for(Long l :  o.getPageDesignKeys()) {
								if(l != null && (setPageDesignKeysValues == null || !setPageDesignKeysValues.contains(l))) {
									futures.add(Future.future(a -> {
