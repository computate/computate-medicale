...
/**
 * Traduire: false
 * NomCanonique.enUS: org.computate.medicale.enUS.design.PageDesignEnUSGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface DesignPageFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate-medicale-frFR-DesignPage").register(DesignPageFrFRGenApiService.class, new DesignPageFrFRApiServiceImpl(siteContexte));
	}
