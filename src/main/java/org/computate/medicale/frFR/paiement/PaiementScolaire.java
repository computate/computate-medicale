...
/**    
 * NomCanonique.enUS: org.computate.medicale.enUS.payment.SchoolPayment
 * Modele: true
 * Api: true
 * Indexe: true
 * Sauvegarde: true
 ...
 * Lignes: 50
*/   
public class Paiementmedicale extends PaiementmedicaleGen<Cluster> {
	 ...
	 * Indexe: true
	 * Stocke: true
	 * Attribuer: Inscriptionmedicale.paiementCles
	 * HtmlLigne: 7
	 * HtmlCellule: 2
	 ...
	 * Ignorer: true
	 */   
	protected void _inscription_(Couverture<Inscriptionmedicale> c) {
	 ...
	 * Indexe: true
	 * Stocke: true
	 * Description.frFR: L'année medicale de l'paiement medicale. 
	 ...
	 * Indexe: true
	 * Stocke: true
	 * Description.frFR: La saison medicale de l'paiement medicale. 
