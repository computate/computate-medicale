...
/**
 * Traduire: false
 * NomCanonique.enUS: org.computate.medicale.enUS.user.SiteUserEnUSGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface UtilisateurSiteFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate-medicale-frFR-UtilisateurSite").register(UtilisateurSiteFrFRGenApiService.class, new UtilisateurSiteFrFRApiServiceImpl(siteContexte));
	}
