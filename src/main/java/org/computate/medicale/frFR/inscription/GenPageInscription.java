...
public class GenPageInscription extends GenPageInscriptionGen<ClusterPage> {
	...
	public void htmlBodyFormsGenPageInscription() {
			...
			if(listeInscriptionMedicale != null && listeInscriptionMedicale.size() == 1) {
				{ e("button")
					.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-blue-gray ")
						...
						.a("onclick", "patchInscriptionMedicaleVals( [ {name: 'fq', value: 'pk:' + " + requeteSite_.getRequetePk() + " } ], {}, function() { ajouterLueur($('#rechargerCetteGenPageInscription')); }, function() { ajouterErreur($('#rechargerCetteGenPageInscription')); }); return false; ").f();
		...
		htmlSuggereGenPageInscription(this, null, listeInscriptionMedicale);
	}

	/**
	**/
	public static void htmlSuggereGenPageInscription(MiseEnPage p, String id, ListeRecherche<InscriptionMedicale> listeInscriptionMedicale) {
		...
		try {
			...
			if(
					...
					{ p.e("div").a("class", "").f();
						{ p.e("button").a("id", "rechargerToutesGenPageInscription", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-blue-gray ").a("onclick", "patchInscriptionMedicaleVals([], {}, function() { ajouterLueur($('#rechargerToutesGenPageInscription", id, "')); }, function() { ajouterErreur($('#rechargerToutesGenPageInscription", id, "')); }); ").f();
