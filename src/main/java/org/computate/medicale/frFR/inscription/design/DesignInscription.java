...
/**    
 * NomCanonique.enUS: org.computate.medicale.enUS.enrollment.design.EnrollmentDesign
 * Modele: true
 * Api: true
 * Indexe: true
 * Sauvegarde: true
...
public class DesignInscription extends DesignInscriptionGen<Cluster> {
	 ...
	 * Indexe: true
	 * Stocke: true
	 * Attribuer: Anneemedicale.designInscriptionCle
	...
	*/        
	 ...
	 * Indexe: true
	 * Stocke: true
	 * Attribuer: Inscriptionmedicale.designInscriptionCle
	 ...
	 */
	protected void _anneeRecherche(ListeRecherche<Anneemedicale> l) {
		l.setQuery("*:*");
		l.addFilterQuery("designInscriptionCle_indexed_long:" + pk);
		l.setC(Anneemedicale.class);
		l.setStocker(true);
	}
	 ...
	 * Ignorer: true
	 */           
	protected void _annee_(Couverture<Anneemedicale> c) {
