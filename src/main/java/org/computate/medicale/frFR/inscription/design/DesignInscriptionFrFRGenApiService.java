...
/**
 * Traduire: false
 * NomCanonique.enUS: org.computate.medicale.enUS.enrollment.design.EnrollmentDesignEnUSGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface DesignInscriptionFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate-medicale-frFR-DesignInscription").register(DesignInscriptionFrFRGenApiService.class, new DesignInscriptionFrFRApiServiceImpl(siteContexte));
	}
